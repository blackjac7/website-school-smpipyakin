...
export default function Header({
  ...
  return (
    <motion.header
      ...
      className="bg-white/80 backdrop-blur-md border-b border-green-100 px-4 md:px-6 py-4 sticky top-0 z-40"
    >
        ...
        <div className="flex items-center gap-3">
          ...
          {onToggleSidebar && (
            <button
              ...
              className="lg:hidden p-2 rounded-xl hover:bg-green-50 transition-all duration-200 group"
          ...
          >
            <div className="hidden sm:flex p-2.5 bg-linear-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg shadow-green-200">
          ...
          <div className="relative">
            ...
            <AnimatePresence>
              {showNotifications && (
                ...
                >
                  <div className="p-4 border-b border-gray-100 bg-linear-to-r from-green-50 to-emerald-50">
