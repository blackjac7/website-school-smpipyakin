...
export default function ValidationContentEnhanced({
  ...
  return (
    <div className="space-y-6">
        ...
        {applicants.map((applicant) => (
          ...
          >
            <div className="flex items-start gap-3 mb-3">
              <div className="w-10 h-10 shrink-0 bg-linear-to-br from-blue-100 to-indigo-100 text-blue-600 rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-xs text-gray-500 flex items-center gap-1 mt-0.5">
                  ...
                  <span>• {applicant.gender === "MALE" ? "L" : "P"}</span>
                </div>
              </div>
            ...
            <div className="space-y-1.5 mb-3 text-sm">
              <div className="flex items-center gap-2 text-gray-600">
                ...
                <span className="truncate">
                  {applicant.parentName} • {applicant.parentContact}
                </span>
              </div>
              <div className="flex items-center gap-2 text-gray-600">
                <School className="w-3.5 h-3.5 text-gray-400 shrink-0" />
                <span className="truncate">{applicant.asalSekolah || "-"}</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all text-sm font-medium shadow-sm"
            >
      ...
      {totalPages > 0 && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
