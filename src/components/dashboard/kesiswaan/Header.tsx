...
export default function Header({
  ...
  const getHeaderTitle = () => {
    switch (activeMenu) {
      case "validation":
        return "Validasi Konten";
      case "reports":
        return "Laporan Validasi";
      default:
        return "Pengaturan";
    }
  };
  ...
  const getHeaderDescription = () => {
    switch (activeMenu) {
      case "validation":
        return "Review dan validasi konten dari OSIS dan siswa";
      case "reports":
        return "Analisis dan statistik validasi konten";
      default:
        return "Pengaturan sistem validasi";
    }
  };
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{getHeaderDescription()}</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          {/* Notification Bell */}
