...
export default function CategoryFilter({
  ...
  return (
    <div className="flex flex-wrap justify-center gap-2 p-1.5 bg-white/50 backdrop-blur-sm border border-gray-100 rounded-full shadow-sm max-w-fit mx-auto mb-10">
